...
const fonts = {
  ...
  ["older-to-woff"]() {
    return _.gulp.src(config.path.older, { encoding: false })
  ...
  ["svg-to-woff"]() {
    return _.gulp.src(config.path.svg, { encoding: false })
      .pipe(_.plumber(config.modules.plumber))
      .pipe(_.svg2ttf())
      .pipe(_.ttf2woff2())
      .pipe(_.gulp.dest(config.path.dest));
  ...
  ["ttf-to-woff"]() {
    return _.gulp.src(config.path.ttf, { encoding: false })
      .pipe(_.plumber(config.modules.plumber))
      .pipe(_.ttf2woff2())
      .pipe(_.gulp.dest(config.path.dest));
  },
  ["woff"]() {
    return _.gulp.src(config.path.woff, { encoding: false })
      .pipe(_.plumber(config.modules.plumber))
      .pipe(_.gulp.dest(config.path.dest));
  },
  ["font-face"]() {
